...
fun getRecentMovies(): List<Movie> {
    return listOf(
        Movie(1,"Furiosa: A Mad Max Saga",
            ...
            "action", "res/drawable/furiosa.jpg"
        ),
        Movie(2, "Inside Out 2",
            ...
            "animation", "res/drawable/insideout2.jpg"
        ),
        ...
        Movie(5, "IF",
            ...
            "comedy", "res/drawable/ifmovie.jpg"
        )
    )
}
